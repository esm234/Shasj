...
def main():
    ...
    application.add_handler(MessageHandler(filters.Chat(ADMIN_GROUP_ID) & (filters.TEXT | filters.PHOTO | filters.VOICE | filters.AUDIO | filters.DOCUMENT), handle_admin_reply_or_broadcast))
